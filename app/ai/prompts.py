RESUME_PARSER_PROMPT = (
        ...
        '- projects: A list of personal, academic, or freelance projects that are not formal employment. Include the "project\'s name)", a brief "description", "team size" (use 0 if not specified), and "time of the project". If not found, leave as [].\n'
        ...
        '        ],\n'
        '        "projects": [\n'
        '            {{"name": "CV Analysis System", "description": "Developed a FastAPI backend to parse resumes.", "team_size": 1, "time_of_project": "Q1 2024"}}\n'
        '            {{"name": "Customer Relationship Application", "description": "Designed and implemented a full-stack web application to manage client interactions and sales pipelines.", "team_size": 3, "time_of_project": "2023-2024"}}\n'
        '        ],\n'
        '        "education": [\n'
...
INTERVIEW_QUESTION_PROMPT = (
            ...
            'INSTRUCTIONS: '
            '1. Analyze the CV text to understand their experience, skills, and projects.\n'            
            '2. Generate a total of approximately 20 relevant and specific interview questions to their skills, projects and work experience.\n'
            '3. Ensure the questions\' **difficulty level is proportional to the candidate\'s experience**. If the candidate is a senior professional, ask questions that challenge them at a senior level (e.g., about system design, tradeoffs, and mentorship). If they are a junior, focus on fundamentals.\n'  
            '4. Group the questions into the following topics:\n'
            ...
            '5. For each question, assign a difficulty level: "easy", "medium", or "hard".\n\n'
            'INPUT: The extracted CV text is below.\n'
            '```text\n'
            '{documents}\n'
            '```\n\n'
